      ...
      <div className="flex gap-2">
        <div className="relative flex-1">
          <Input
            ...
            className="w-full pl-4 pr-10 py-2 text-sm rounded-xl border border-primary/20 focus:border-primary focus:ring-primary/20 bg-white/80 dark:bg-gray-800/80 dark:text-gray-100 dark:placeholder-gray-400 backdrop-blur-sm shadow-sm"
            disabled={isLocked}
          />
        </div>
        <Button 
